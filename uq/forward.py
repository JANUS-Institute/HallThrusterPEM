"""Module for forward uncertainty quantification tasks (i.e. Sobol and Monte Carlo)"""
import numpy as np
import sys
...
from models.simple_models import ishigami
...
if __name__ == '__main__':
    ...
    sobol_sa(ishigami, lhc_sampler, 10000, cmap='summer')
