...
def train():
    with MPICommExecutor(MPI.COMM_WORLD, root=0) as executor:
        if executor is not None:
            ...
            sys.build_system(qoi_ind=qoi_ind, N_refine=100, max_iter=5, max_tol=1e-5, max_runtime=end_time_s,
                             save_interval=1, test_set=test_set, prune_tol=1e-6, n_jobs=-1)
