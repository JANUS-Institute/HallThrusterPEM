...
def test_random_samples(tmp_path, plots=SHOW_PLOTS):
    ...
    outputs_rand = current_density(inputs_rand, output_path=tmp_path)
...
def test_pressure_sweep(tmp_path, plots=SHOW_PLOTS):
    ...
    outputs_sweep = current_density(inputs_sweep, output_path=tmp_path)
